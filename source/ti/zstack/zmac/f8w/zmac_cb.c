...
void MAC_CbackEvent(macCbackEvent_t *pData)
{
  ...
  {
    uint8_t *originalMsdup = (uint8_t *)pData->dataCnf.pDataReq + sizeof(macMcpsDataReq_t) + MAC_DATA_OFFSET;
    pData->dataCnf.pDataReq->msdu.len -= (uint8_t)(originalMsdup - pData->dataCnf.pDataReq->msdu.p);
