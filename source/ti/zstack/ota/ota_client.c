...
static void otaClient_StartTimer ( Clock_Handle cHandle, Clock_Struct *cStruct,  uint32_t seconds);
static void otaClient_StartTimeoutEvent( Clock_Handle cHandle, Clock_Struct *cStruct,  uint32_t mSeconds);
