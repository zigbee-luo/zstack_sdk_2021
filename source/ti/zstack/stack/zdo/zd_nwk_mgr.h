...
// Threshold to change Panid when receive network-rport command in 1-minute
#if !defined ( ZDNWKMGR_PANID_CONFLICT_THRESHOLD )
  #define ZDNWKMGR_PANID_CONFLICT_THRESHOLD      2
#endif
...
#define ZDNWKMGR_PANID_CONFLICT_EVT       0x0010 //add by luoyiming, 2019-08-20
