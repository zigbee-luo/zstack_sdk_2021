...
Clock_Struct gpAppDataSendClk;
Clock_Handle gpAppDataSendClkHandle;
Clock_Struct gpAppExpireDuplicateClk;
Clock_Handle gpAppExpireDuplicateClkHandle;
Clock_Struct gpAppTempMasterTimeoutClk;
Clock_Handle gpAppTempMasterTimeoutClkHandle;
uint8_t gpAppEntity;
 ...
 * LOCAL FUNCTIONS
 */
static ZStatus_t zclGp_ReadWriteAttrCB( uint8_t endpoint, zclAttrRec_t *pAttr, uint8_t oper, uint8_t *pValue, uint16_t *pLen );
 ...
 *********************************************************************/
  ...
  * @return  status
  */
static ZStatus_t zclGp_ReadWriteAttrCB( uint8_t endpoint, zclAttrRec_t *pAttr, uint8_t oper,
