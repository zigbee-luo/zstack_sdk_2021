...
typedef struct _zstack_nodedescriptor_t
{
    ...
    /** Statck Rev, add by luoyiming 2019-12-02 */
    uint8_t stackRev;
...
/**
 * The callback function of AF Data Confirm,added by Luoyiming
 */
typedef void zstack_AfCnfCb_t(uint8_t status, uint8_t endpoint, uint8_t transID, uint16_t clusterID, void* cnfParam);
...
typedef struct _zstack_afdatareq_t
{
    ...
    uint8_t *pPayload;
    /** Function pointer of confirm callback,added by Luoyiming **/
    zstack_AfCnfCb_t* afCnfCB;
    /** parameter of confirm callback,added by Luoyiming **/
    void *cnfParam;
} zstack_afDataReq_t;
...
typedef struct _zstack_afdataconfirmind_t
{
    ...
    uint16_t clusterID;
    //! callback's fuction pointer for AF Data Confirm,added by Luoyiming
    zstack_AfCnfCb_t* afCnfCB;
    //! parameter for callback of AF Data Confirm,added by Luoyiming
    void *cnfParam;
...
typedef struct _zstack_afreflecterrorind_t
{
    ...
    //! Destination Address
    zstack_AFAddr_t dstAddr;
    //! cnfParam pointer of AF_data_request,added by Luoyiming
    void *cnfParam;
...
/*
 * Structure of ZDO send external parameter
 */
typedef struct _zstack_zdoExtParam_t
{
...
{
    //! Trans Sequence, add by luoyiming
    uint8_t transSeq;
    /** Response status */
...
typedef struct _zstack_bdbrepaddattrcfgrecorddefaulttolistreq_t
{
  ...
  /** Cluster */
  uint16_t cluster;
  /** Manu Code, add by luoyiming 2019-10-21 */
  uint16_t manuCode;
  /** direction, add by luoyiming 2020-01-07 */
  uint8_t direction;
  /** Attribute ID */
  uint16_t attrID;
