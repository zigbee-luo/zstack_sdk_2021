...
#ifndef TOUCHLINK_NUM_DEVICE_INFO_ENTRIES 
  #define TOUCHLINK_NUM_DEVICE_INFO_ENTRIES                      TOUCHLINK_DEVICE_INFO_RSP_REC_COUNT_MAX
#endif
...
extern bdbTLDeviceInfo_t *touchLinkSubDevicesTbl[TOUCHLINK_NUM_DEVICE_INFO_ENTRIES];
