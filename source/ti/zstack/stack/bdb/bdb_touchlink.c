...
//#define TOUCHLINK_NUM_DEVICE_INFO_ENTRIES              5 // fixed by luoyiming
...
bdbTLDeviceInfo_t *touchLinkSubDevicesTbl[TOUCHLINK_NUM_DEVICE_INFO_ENTRIES]; // fixed by luoyiming
