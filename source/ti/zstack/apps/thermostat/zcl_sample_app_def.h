...
#define CUI_APP_MENU    CUI_MENU_ITEM_INT_ACTION("< SET HEAT TEMP  >", (CUI_pFnIntercept_t) zclSampleThermostat_UiActionSetHeatPoint) \
                        CUI_MENU_ITEM_INT_ACTION("< SET COOL TEMP  >", (CUI_pFnIntercept_t) zclSampleThermostat_UiActionSetCoolPoint)
#else

#define SAMPLE_APP_MENUS  3
#define CUI_APP_MENU    CUI_MENU_ITEM_INT_ACTION("< SET HEAT TEMP  >", (CUI_pFnIntercept_t) zclSampleThermostat_UiActionSetHeatPoint) \
                        CUI_MENU_ITEM_INT_ACTION("< SET COOL TEMP  >", (CUI_pFnIntercept_t) zclSampleThermostat_UiActionSetCoolPoint) \
                        CUI_MENU_ITEM_ACTION("< GPS COMMISSION >", (CUI_pFnAction_t) zclSampleThermostat_setGPSinkCommissioningMode)
