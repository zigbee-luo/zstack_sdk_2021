 ...
 * CONSTANTS
 */
#define SAMPLEWARNINGDEVICE_ENDPOINT               8
...
#define SAMPLEAPP_WARNING_DURATION_EVT   0x0008
#define SAMPLEAPP_SQUAWK_UI_TIMEOUT_EVT  0x0010

#define SAMPLEAPP_END_DEVICE_REJOIN_DELAY 1000
#define SAMPLEAPP_AUTO_ENROLL_REQ_DELAY   500
#define SAMPLEAPP_SQUAWK_UI_TIMEOUT       1000
...
extern uint16_t zclSampleWarningDevice_IdentifyTime;

extern CONST uint8_t zclSampleWarningDevice_NumAttributes;

extern uint8_t  zclSampleWarningDevice_ZoneState;
extern uint16_t zclSampleWarningDevice_ZoneType;
extern uint16_t zclSampleWarningDevice_ZoneStatus;
extern uint8_t  zclSampleWarningDevice_CIE_Address[8];
extern uint8_t  zclSampleWarningDevice_ZoneId;
extern uint16_t zclSampleWarningDevice_MaxDuration;
/*********************************************************************
 * FUNCTIONS
 */
