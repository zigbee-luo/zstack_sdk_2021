/**************************************************************************************************
  ...
  Revised:        $Date: 2015-02-16 17:06:31 -0800 (Mon, 16 Feb 2015) $
  Revision:       $Revision: 42658 $
...
/* 786432 backoffs or 251.65824 Seconds */
#define MAC_BACKOFF_TIMER_DEFAULT_NONBEACON_ROLLOVER  MAC_BACKOFF_TIMER_DEFAULT_ROLLOVER
...
MAC_INTERNAL_API uint16 macGetRadioTxPowerReg(uint8 *pTxPower);
...
MAC_INTERNAL_API void macBackoffTimerCancelTriggerWakeup(void);
